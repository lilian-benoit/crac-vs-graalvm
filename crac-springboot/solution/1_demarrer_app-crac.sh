...
echo "$JAVA_HOME/bin/java --add-opens=java.base/java.lang=ALL-UNNAMED -XX:CRaCCheckpointTo=/tmp/crac-files/springboot -jar target/$ARCHIVE"
$JAVA_HOME/bin/java --add-opens=java.base/java.lang=ALL-UNNAMED -XX:CRaCCheckpointTo=/tmp/crac-files/springboot -jar target/$ARCHIVE
